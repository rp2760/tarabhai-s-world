    ...
    const fetchCart = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const taxAmount = data.subtotal * 0.18;
          ...
          {step === 3 && (
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div 
                  className={`border rounded-md p-4 cursor-pointer ${paymentMethod === 'wallet' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-300'}`}
                  onClick={() => handlePaymentMethodSelect('wallet')}
                >
                  <div className="flex items-center">
                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center mr-3 ${paymentMethod === 'wallet' ? 'border-indigo-600 bg-indigo-600' : 'border-gray-400'}`}>
